...
export function Button({
  ...
  const variantClasses = {
    primary: 'bg-primary-600 text-slate-50 hover:bg-primary-700 focus:ring-primary-500',
    secondary: 'bg-slate-200 text-slate-800 hover:bg-slate-300 focus:ring-slate-500',
    danger: 'bg-red-600 text-slate-50 hover:bg-red-700 focus:ring-red-500',
    ghost: 'bg-transparent text-slate-600 hover:bg-slate-200 focus:ring-slate-500',
  };
